...
/** List file of native system certificates generated by the module */
export const SYSTEM_CERTS_LIST_PATH = '/data/adb/modules/MoveCertificate/system_certs.txt';
/** 证书名称本地缓存文件，内置常见证书名称，并追加远程 API 识别结果，避免重复请求 */
export const CERT_NAME_CACHE_PATH = '/data/adb/modules/MoveCertificate/cert_names.json';
